...
Material* json_parse_material(const jsonvalue& json) {
    ...
    json_set_optvalue(json, material->tile, "tile");
    return material;
}
...
Surface* json_parse_surface(const jsonvalue& json) {
    ...
    if(json.object_contains("iscylinder")) json_set_optvalue(json, surface->iscylinder,"iscylinder");
    if(json.object_contains("height")) json_set_optvalue(json, surface->height,"height");
